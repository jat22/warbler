...
class MessageViewTestCase(TestCase):
	...
	def setUp(self):
		...
		self.u1 = User.signup("abc", "test1@test.com", "password", None, None)
		self.u1_id = 778
		self.u1.id = self.u1_id
		self.u2 = User.signup("efg", "test2@test.com", "password", None, None)
		self.u2_id = 884
		self.u2.id = self.u2_id
		self.u3 = User.signup("hij", "test3@test.com", "password", None, None)
		self.u4 = User.signup("testing", "test4@test.com", "password", None, None)
...
####### why are they including the @ as part of this test? whether its there or not the test passes and its only generated when template is rendered.
...
############################ need to spend some time in the beatiful soup docs; understand 80% of this.
			self.assertIn("@testuser", str(resp.data))
...
#################################
##### like tests are failing because of 404 error and I'm sure why. 
#################################
